...
class SaleOrderLine(models.Model):
    ...
    amount_of_separation = fields.Monetary(string="Monto de Separacion", default=2000.0)
        
    @api.depends('product_uom_qty', 'discount', 'price_unit', 'tax_id', 'initial_fee', 'amount_of_separation')
